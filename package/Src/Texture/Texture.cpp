...
int TextureCaterogySize[] = {
	...
	TitleObjectCategoryTextureList::TITLE_OBJECT_TEXTURE_MAX,
	GameObjectCategoryTextureList::GAME_OBJECT_TEXTURE_MAX,
	...
	MonitorCategoryTextureList::GameMonitorTextureMax,
