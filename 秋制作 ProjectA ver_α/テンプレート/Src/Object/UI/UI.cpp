...
void UI::Init()
{
	...
	case ObjID::BUTTON_WORKSHOP:
		...
		m_Tex = GetTexture(TEXTURE_CATEGORY_GAME_OBJECT, GameObjectCategoryTextureList::OBJECT_MONITOR_BUTTOM_TEX);
		break;
	...
	case ObjID::BUTTON_ON_WORKSHOP:
		m_Pos = WORKSHOP_BUTTON_POS;
		m_Size = MONITOR_BUTTON_SIZE;
		m_Tex = GetTexture(TEXTURE_CATEGORY_GAME_OBJECT, GameObjectCategoryTextureList::OBJECT_MONITOR_ONBUTTOM_TEX);
		break;
